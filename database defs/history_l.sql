...
-- ----------------------------
-- Table structure for history_l
-- ----------------------------
DROP TABLE IF EXISTS `history_l`;
CREATE TABLE `history_l`  (
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '长视频历史记录' ROW_FORMAT = DYNAMIC;
