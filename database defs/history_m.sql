...
-- ----------------------------
-- Table structure for history_m
-- ----------------------------
DROP TABLE IF EXISTS `history_m`;
CREATE TABLE `history_m`  (
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '中视频历史记录' ROW_FORMAT = DYNAMIC;
